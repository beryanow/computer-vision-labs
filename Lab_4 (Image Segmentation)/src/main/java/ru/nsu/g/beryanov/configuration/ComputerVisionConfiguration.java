...
public class ComputerVisionConfiguration {
    ...
    public ImagePanel imagePanel() {
        ComputerVisionUtility.imageName = "siba_small1";
    ...
    public JPanel toolPanel() {
        ...
        toolPanel.add(cleanBackgroundButton());
    ...
    @Bean("cleanBackgroundButton")
    public JButton cleanBackgroundButton() {
        JButton cleanBackgroundButton = new JButton("Очистить фон");

        cleanBackgroundButton.addActionListener(actionEvent -> toolController.cleanBackground());
        cleanBackgroundButton.setAlignmentX(java.awt.Component.CENTER_ALIGNMENT);

        return cleanBackgroundButton;
    }
