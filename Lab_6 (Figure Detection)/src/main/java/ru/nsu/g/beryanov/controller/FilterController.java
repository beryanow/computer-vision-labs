...
public class FilterController {
    ...
    public int[][] processSobelFilter() {
        ...
        int[][] rgb = new int[ComputerVisionUtility.imageSize][ComputerVisionUtility.imageSize];
        ...
        for (int i = 0; i < ComputerVisionUtility.imageSize; i++) {
            for (int j = 0; j < ComputerVisionUtility.imageSize; j++) {
                ...
                rgb[i][j] = new Color(RGB[0], RGB[1], RGB[2]).getRGB();
