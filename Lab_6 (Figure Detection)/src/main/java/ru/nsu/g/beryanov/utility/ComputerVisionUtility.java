...
public class ComputerVisionUtility {
    ...
    public double[][] getSobelFilterX5() {
        return new double[][]{new double[]{-5, -4, 0, 4, 5},
                new double[]{-8, -10, 0, 10, 8},
                new double[]{-10, -20, 0, 20, 10},
                new double[]{-8, -10, 0, 10, 8},
                new double[]{-5, -4, 0, 4, 5}};
    }

    public double[][] getSobelFilterY5() {
        return new double[][]{new double[]{-5, -8, -10, -8, -5},
                new double[]{-4, -10, -20, -10, -4},
                new double[]{0, 0, 0, 0, 0},
                new double[]{4, 10, 20, 10, 4},
                new double[]{5, 8, 10, 8, 5}};
    }

    public double[][] getSobelFilterX7() {
        return new double[][]{new double[]{-3.0 / 18, -2.0 / 13, -1.0 / 10, 0, 1.0 / 10, 2.0 / 13, 3.0 / 18},
                new double[]{-3.0 / 13, -2.0 / 8, -1.0 / 5, 0, 1.0 / 5, 2.0 / 8, 3.0 / 13},
                new double[]{-3.0 / 10, -2.0 / 5, -1.0 / 2, 0, 1.0 / 2, 2.0 / 5, 3.0 / 10},
                new double[]{-3.0 / 9, -2.0 / 4, -1.0, 0, 1.0, 2.0 / 4, 3.0 / 9},
                new double[]{-3.0 / 10, -2.0 / 5, -1.0 / 2, 0, 1.0 / 2, 2.0 / 5, 3.0 / 10},
                new double[]{-3.0 / 13, -2.0 / 8, -1.0 / 5, 0, 1.0 / 5, 2.0 / 8, 3.0 / 13},
                new double[]{-3.0 / 18, -2.0 / 13, -1.0 / 10, 0, 1.0 / 10, 2.0 / 13, 3.0 / 18}};
    }

    public double[][] getSobelFilterY7() {
        return new double[][]{new double[]{-3.0 / 18, -3.0 / 13, -3.0 / 10, -3.0 / 9, -3.0 / 10, -3.0 / 13, -3.0 / 18},
                new double[]{-2.0 / 13, -2.0 / 8, -2.0 / 5, -2.0 / 4, -2.0 / 5, -2.0 / 8, -2.0 / 13},
                new double[]{-1.0 / 10, -1.0 / 5, -1.0 / 2, -1.0, -1.0 / 2, -1.0 / 5, -1.0 / 10},
                new double[]{0, 0, 0, 0, 0, 0, 0},
                new double[]{1.0 / 10, 1.0 / 5, 1.0 / 2, 1.0, 1.0 / 2, 1.0 / 5, 1.0 / 10},
                new double[]{2.0 / 13, 2.0 / 8, 2.0 / 5, 2.0 / 4, 2.0 / 5, 2.0 / 8, 2.0 / 13},
                new double[]{3.0 / 18, 3.0 / 13, 3.0 / 10, 3.0 / 9, 3.0 / 10, 3.0 / 13, 3.0 / 18}};
    }
