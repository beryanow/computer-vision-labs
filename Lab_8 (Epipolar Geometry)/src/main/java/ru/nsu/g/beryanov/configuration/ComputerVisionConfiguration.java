...
import ru.nsu.g.beryanov.controller.EpipolarGeometryController;
...
public class ComputerVisionConfiguration {
    ...
    @Autowired
    private EpipolarGeometryController epipolarGeometryController;
    ...
    public ImagePanel imagePanel() {
        ComputerVisionUtility.imageName = "porshe1";
    ...
    public JPanel toolPanel() {
        ...
        toolPanel.add(Box.createRigidArea(new Dimension(0, 10)));
        toolPanel.add(lucasKanadeMethodButton());
        toolPanel.add(Box.createRigidArea(new Dimension(0, 10)));
        toolPanel.add(disparityMapButton());
    ...
    @Bean("lucasKanadeMethodButton")
    public JButton lucasKanadeMethodButton() {
        JButton lucasKanadeMethodButton = new JButton("Лукас-Канаде");

        lucasKanadeMethodButton.addActionListener(actionEvent -> descriptorController.processLucasKanadeMethod());
        lucasKanadeMethodButton.setAlignmentX(java.awt.Component.CENTER_ALIGNMENT);

        return lucasKanadeMethodButton;
    }

    @Bean("disparityMapButton")
    public JButton disparityMapButton() {
        JButton disparityMapButton = new JButton("Карта глубины");

        disparityMapButton.addActionListener(actionEvent -> epipolarGeometryController.evaluateDisparityMap());
        disparityMapButton.setAlignmentX(java.awt.Component.CENTER_ALIGNMENT);

        return disparityMapButton;
    }
